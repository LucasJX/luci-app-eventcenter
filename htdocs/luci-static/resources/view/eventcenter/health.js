...
;(function(){
	...
	s.textContent=[
		...
		'.ec-muted{color:#9ca3af}.cbi-page-actions{display:none!important}.ec-actions-bar{display:flex;justify-content:flex-end;gap:10px;padding:16px 0;margin-top:8px;border-top:1px solid #e5e7eb}.ec-btn{padding:9px 24px;border-radius:8px;font-size:.84em;font-weight:600;cursor:pointer;transition:all .15s;border:none}.ec-btn-primary{background:#7c3aed;color:#fff;box-shadow:0 2px 6px rgba(124,58,237,.25)}.ec-btn-primary:hover{background:#6d28d9}.ec-btn-warning{background:#f59e0b;color:#fff;box-shadow:0 2px 6px rgba(245,158,11,.25)}.ec-btn-warning:hover{background:#d97706}.ec-btn-ghost{background:#f3f4f6;color:#6b7280}.ec-btn-ghost:hover{background:#e5e7eb;color:#374151}'
	].join('\n');
